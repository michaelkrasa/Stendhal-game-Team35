...
public class EmotionCrystals extends AbstractQuest {
	...
	public static List<String> gatheredCrystals = new ArrayList<String>();
	...
	public List<String> getHistory(final Player player) {
		...
		for (String color : crystalColors) {
			if (!gatheredCrystals.contains(color + " emotion crystal") && player.isEquipped(color + " emotion crystal")) {
